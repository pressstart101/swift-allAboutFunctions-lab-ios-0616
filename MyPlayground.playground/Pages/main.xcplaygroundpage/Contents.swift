...
func characterFunction(name: String) {
    print("My favorite character is \(name)")
}

characterFunction("zombie")
/*: question4
 ### 4. Call the function you wrote in Question 3 using a constant you define. Then call it using a variable. Change the value of the variable, and call it again. What do you see in the console?
 */
// write your code here
let characterName = "zombie"
characterFunction(characterName)
var characterValue = "otherZombie"
characterFunction(characterName)
...
func aboutBand (bandName: String, number: Int) {
    print("My #\(number) favorite band is \(bandName)")
}

aboutBand("The Internet", number: 7)
/*: question7
...
madLib("girls", noun: "take over", preposition: "the World")
/*: question10
